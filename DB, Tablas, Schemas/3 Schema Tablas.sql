...
FROM 'C:\proyectos-trabajo\Analisis_datos\kaggle\pizza-sales\order_details.csv'
WITH(
	FIELDTERMINATOR = ',',
	ROWTERMINATOR = '\n',
	FIRSTROW = 2);
...
FROM 'C:\proyectos-trabajo\Analisis_datos\kaggle\pizza-sales\orders.csv'
WITH(
	FIELDTERMINATOR = ',',
	ROWTERMINATOR = '\n',
	FIRSTROW = 2);
...
FROM 'C:\proyectos-trabajo\Analisis_datos\kaggle\pizza-sales\pizza_types.csv'
WITH(
	FIELDTERMINATOR = ',',
	ROWTERMINATOR = '\n',
	FIRSTROW = 2);
...
FROM 'C:\proyectos-trabajo\Analisis_datos\kaggle\pizza-sales\pizzas.csv'
WITH(
	FIELDTERMINATOR = ',',
	ROWTERMINATOR = '\n',
	FIRSTROW = 2);
